...
export const EQUIPMENTS_ALL_SPRITE = [
  EQU.SHARD_HELMET, EQU.ROOKIE_SHOULDERGUARDS, EQU.FLINT_BOOTS, EQU.HATCHET, EQU.CRESCENT,
  EQU.CLEAVING_AX, EQU.SCRAPPY_AX, EQU.ROGASA, EQU.GREENHORN_PONCHO, EQU.TUFTED_SANDALS,
  EQU.SWALLOW, EQU.BLACKBIRD, EQU.HERON, EQU.COZY_ROBE, EQU.COZY_HOOD, EQU.FEATHER_CAP, EQU.DOWN_VEST
]
...
export const FINISHING_DURATION_DEFAULT = (40 / ANIMATION_SPEED);
