...
export const EQUIPMENTS_ALL_SPRITE = [
  EQU.SHARD_HELMET, EQU.ROOKIE_SHOULDERGUARDS, EQU.WALKING_BOOTS, EQU.HATCHET, EQU.CRESCENT,
  EQU.REVEL, EQU.CLEAVING_AX, EQU.SCRAPPY_AX, EQU.ROGASA, EQU.GREENHORN_PONCHO,
  EQU.SPARROW, EQU.STARLING, EQU.BLACKBIRD, EQU.HERON, EQU.COZY_ROBE, EQU.COZY_HOOD, EQU.FEATHER_CAP,
  EQU.DOWN_VEST, EQU.RUFFLED_SHIRT, EQU.CLOUDY_CAP
];
