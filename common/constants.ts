...
export const LAYERED_ANIMATED_STATES_ALL = [
  LAS.RESTING, LAS.WALKING, LAS.SWINGING, LAS.THROWING, LAS.CLENCHING, LAS.CROUCHING, LAS.DOWN
];
export const LAYERED_ANIMATED_STATES_DEBUG = [
  ...
  LAS.SWINGING2, LAS.CASTING, LAS.THROWING, LAS.CLENCHING, LAS.CROUCHING, LAS.DOWN
];
