...
export const CHARACTER_CLASSES_ALL_SPRITE = [CHC.JAVALIN, CHC.RAIDER, CHC.BLUE_MAGE];
export const EQUIPMENTS_ALL_SPRITE = [
  EQU.SHARD_HELMET, EQU.ROOKIE_SHOULDERGUARDS, EQU.WALKING_SHOES, EQU.HATCHET, EQU.CRESCENT,
  EQU.REVEL, EQU.AJAX, EQU.FEIST, EQU.ROGASA, EQU.GREENHORN_PONCHO,
  EQU.SPARROW, EQU.STARLING, EQU.BLACKBIRD, EQU.HERON, EQU.DROPLET_ROBE, EQU.RAINFALL_HOOD,
  EQU.GENTLE_RAIN, EQU.COLDBURST, EQU.FEATHER_HAT,
  EQU.BELTED_OVERALLS, EQU.RUFFLED_SHIRT, EQU.CLOUDY_CAP, EQU.BLUE_SCARF, EQU.RED_SCARF, EQU.GREEN_SCARF
];
...
export const DELAY_BEFORE_DAMAGED_DEFAULT = (30 / ANIMATION_SPEED);
